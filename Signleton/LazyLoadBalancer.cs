//  *****************************************************************************
//  <copyright file="LazyLoadBalancer.cs" company="mainul098@gmail.com">
//      Copyright ©  2017
//  </copyright>
//  <summary>LazyLoadBalancer.cs</summary>
//  *****************************************************************************
namespace Singleton
{
    using System;
    ...
    public class LazyLoadBalancer
    {
        ...
        {
            get { return this.servers[this._random.Next(this.servers.Count)]; }
        }
